      ...
      <div className="container-wide grid gap-14 lg:grid-cols-12 lg:gap-16">
        ...
        >
          ...
          <h2 className="editorial-h2 mt-5">
            Familien­betrieb,
            <br />
            <span className="text-copper">echtes Handwerk.</span>
          </h2>
          <div className="mt-8 space-y-5 text-lg leading-relaxed text-white/75">
            <p>
              Thomas Finder und Dietmar Erler führen die Finder GmbH seit über
              15 Jahren. Ein Berliner Betrieb, kleines Team, Vornamen-Basis.
            </p>
            <p>
              Wir sind die, die du beim ersten Termin kennenlernst und beim
              zweiten Termin wiederfindest. Kein Subunternehmer-Roulette, kein
              wechselndes Personal.
            </p>
          </div>

          <div className="mt-10 grid grid-cols-2 gap-4">
            {/* TODO: echte Portraits ersetzen */}
