...
const frames = [
  {
    ...
    titleLine1: 'Wenn Ihr Wasser',
    titleLine2: 'kalt bleibt,',
    titleAccent: 'sind wir längst unterwegs.',
  },
  {
    src: IMG.hero.handsBoiler,
    alt: 'SHK Monteur arbeitet an einer Brennwerttherme',
    eyebrow: 'Meisterbetrieb in Berlin · Seit 2010',
    titleLine1: 'Mit Sorgfalt',
    titleLine2: 'reparieren.',
    titleAccent: 'Statt einfach austauschen.',
  },
  {
    src: IMG.hero.livingRoom,
    alt: 'Warmes Berliner Wohnzimmer mit modernem Heizkörper',
    eyebrow: 'Finder GmbH · 030 70073555',
    titleLine1: 'Damit Sie sich',
    titleLine2: 'zu Hause fühlen.',
    titleAccent: 'Heute. Und morgen.',
  },
];
